...
/** 
 * 将字符串格式日期，转换为特定格式的date.
 * @param [string] string   -日期格式字符串
 * @param [string] format -日期格式，默认'yyyy-MM-dd'
 * @return {Date} 日期格式，形式为format格式
 */
...
/** 
 * 计算两个时间的差值
 * @param [string] beginTimeStr 开始日期字符串
 * @param [string] endTimeStr 结束日期字符串
 * @return {Object} Days:days,
    ...
    diff:diff
 */
export const dateTimeDiff = function (beginTimeStr,endTimeStr){
	var beginTime=toDate(beginTimeStr);  //开始时间
	var endTime=toDate(endTimeStr);  //结束时间
