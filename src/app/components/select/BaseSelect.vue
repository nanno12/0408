<template>
  <div
    ...
    <el-input
      ...
      @keydown.native.enter="selectOption"
...
<script>
  ...
  import BaseSelectMenu from './BaseSelectDropdown';
  ...
  export default {
    ...
    watch: {
      ...
      query(val) {
        ...
        if (this.remote && typeof this.remoteMethod === 'function') {
          ...
          this.broadcast('BaseOption', 'resetIndex');
    ...
    methods: {
      ...
      handleOptionSelect(option) {
        ...
        this.broadcast('BaseOption','selected'+selectedIndex);
        if (this.multiple) {
          const value = this.value.slice();
