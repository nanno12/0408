/*
 * @description 引入jquery.niceScroll插件，此处为全局配置项
 * @Author: s_xd@winning.com.cn 
 * @Date: 2018-02-04 15:35:45 
 * @Last Modified by: s_xd@winning.com.cn
 * @Last Modified time: 2018-04-21 16:42:11
 */


const PARAME_NICESCROLLOPTIONS={
  cursorcolor: "#999", // 改变滚动条颜色，使用16进制颜色值
  cursoropacitymin: 0.1, // 当滚动条是隐藏状态时改变透明度, 值范围 1 到 0
  ...
  autohidemode: "leave" , // 隐藏滚动条的方式, 可用的值: true | // 无滚动时隐藏 "cursor" | // 隐藏false | // 不隐藏,"leave" | // 仅在指针离开内容时隐藏"hidden" | // 一直隐藏"scroll", // 仅在滚动时显示
  background: "", // 轨道的背景颜色
  iframeautoresize: true, // 在加载事件时自动重置iframe大小
  cursorminheight: 50, // 设置滚动条的最小高度 (像素)
  preservenativescrolling: true, // 你可以用鼠标滚动可滚动区域的滚动条和增加鼠标滚轮事件
  railoffset: { top: 0, left:-2}, // 可以使用top/left来修正位置
  ...
  enablekeyboard: false, // nicescroll可以管理键盘事件
...
export {PARAME_NICESCROLLOPTIONS};
