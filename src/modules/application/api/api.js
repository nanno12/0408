...
const url = {
  query: DEBUGAPI + '/clf/paf/findPafLists',  // 查询标本，器官/系统、部位、名称等配置数据
  add:DEBUGAPI + '/clf/pafbase/addOrUpdatePafTemplate', // 添加或者更新申请单模板，包含了医嘱检查项目信息
  ...
  delete: DEBUGAPI + '/clf/pafbase/deletePafTemplate',  // 删除申请单模板,根据ID进行
