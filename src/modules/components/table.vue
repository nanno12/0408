<template>
  <div>
    <w-table :data="tableData" border style="width: 100%"
      ...
      <w-table-column v-if="isShow.index" type="index" width="55"></w-table-column>
      ...
      <w-table-column
        ...
        <template slot-scope="scope">
          ...
          <!-- <w-button @click="handleCopy(scope.row)" v-if="isShow.copy" type="text" size="small">复制</w-button> -->
          <w-button @click="handleEdit(scope.row)" v-if="!isShow.edit" type="text" size="small">编辑</w-button>
